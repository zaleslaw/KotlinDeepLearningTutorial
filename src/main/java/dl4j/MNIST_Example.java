...
public class MNIST_Example {
    ...
    public static final Logger log = LoggerFactory.getLogger(MNIST_Example.class);
    public static final String basePath = System.getProperty("java.io.tmpdir") + "/mnist";
    public static final String dataUrl = "http://github.com/myleott/mnist_png/raw/master/mnist_png.tar.gz";
